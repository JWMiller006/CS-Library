...
namespace CMDLibrary.Net.Google_Drive
{
    ...
    public class DriveController : IDriveController
    {
        ...
        public DriveController()
        {
            ...
            Thread Files = new Thread(new ThreadStart(GetFilesAsync));
            Files.Start();
        }
        ...
        static readonly TaskCompletionSource<List<GoogleFile>> taskCompletionSource = new TaskCompletionSource<List<GoogleFile>>();
        ...
        public FileStream GetFile(string fileName)
        {
            ...
            DriveService driveServ = new DriveService(new BaseClientService.Initializer()
            {
                HttpClientInitializer = credential
            });
            string fileId;
        ...
        /// <returns>File Stream of Open Path, after downloading the file</returns>
        /// <exception cref="FileNotFoundException"></exception>
        public static void GetFile(string fileName, string OutputFile)
        {
            GoogleCredential credential = GoogleCredential.FromFile(ServPath).CreateScoped(new[] { DriveService.ScopeConstants.Drive });
            DriveService driveServ = new DriveService(new BaseClientService.Initializer()
            {
        ...
        /// var t = new Thread(() => DriveController.GetFile("usernames.txt", "usernames.txt"));
        /// t.Start();
        /// </summary>
